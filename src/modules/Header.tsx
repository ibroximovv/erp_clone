...
const Header = () => {
  ...
  return (
    <>
      ...
      <Modal confirmLoading={isLoading} open={showModal} okText="Chiqish" cancelText="Bekor qilish" onOk={() => logOut()} onCancel={() => setShowModal(false)} title="Tizimdan chiqish"></Modal>
    </>
  )
}
