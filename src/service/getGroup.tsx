    ...
    useEffect(() => {
        instance(url, {
            ...
            res.data.data.map((item:any) => {
                ...
                item.status = item.status ? <Button className="!bg-green-600 !rounded-2xl !p-3" size="small" type="primary">Faol</Button> : <Button className="!bg-red-600 !rounded-2xl !p-3" size="small" type="primary">Faol emas</Button>
